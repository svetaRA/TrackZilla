 ...
 * 
 * static { inMemoryUserList.add(new JwtUserDetails(1L, "learn",
 * "$2a$10$8rhCP0xuGMjmfXJNlGBfvO.5byNbEt3qhVbq5ktqOtVpc53f64jni",
 * "ROLE_USER_2")); inMemoryUserList.add(new JwtUserDetails(2L, "shweta",
 * "$2a$10$qDXZsIwn0QcerzUHyi3EqOZNBYTHZcXxJqDgleI5GXlJBx6dreGGi",
 * "ROLE_USER_2"));
 * 
